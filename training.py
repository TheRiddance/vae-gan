...
def main(_):
    train_data = hdf5_dataset.read_data_set(FLAGS.dataset, image_size=FLAGS.image_size, shape=FLAGS.image_size * FLAGS.image_size, binarized=True, validation=0).train
